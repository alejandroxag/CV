...
tribble(
  ...
  "Economic spillover of an important drink manufacturer", "2019", "", "", "Gathered information of sales, employees and supplies purchases by product of 11 companies in 32 states in Mexico. Designed a relational database to store such information. Developed an internal R package to implement Input-Output methodologies. Delivered through an R Bookdown.",
