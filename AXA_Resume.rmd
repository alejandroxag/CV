...
tribble(
  ...
  "Economic spillover of an important drink manufacturer", "2019", "", "", "Gathered product-level information on sales, employees, and supplies purchases of 11 companies in 32 states in Mexico. Designed a relational database to store such information. Developed an internal R package to implement Input‑Output methodologies. Delivered through an R Bookdown.",
