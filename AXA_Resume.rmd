...
tribble(
  ...
  "R package to scrape the Mexican President press conferences @ github.com/alejandroxag/amloconf (Personal Pet Project)", "October 2020", "", "", "Developed an R package to retrieve the stenographic versions of the Mexican President's conferences in dialog-formatted lists, for text mining or sentiment analysis.",
